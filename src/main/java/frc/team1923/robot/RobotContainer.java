...
public class RobotContainer {
    ...
    public final Limelight new_limeLight = new Limelight();
    public final IndexerCycleCommand indexercyclecommand = new IndexerCycleCommand(indexer);
    public final ShooterShootCommand shooterCommand = new ShooterShootCommand(shooter);
    ...
    public RobotContainer() {
        ...
        //     .deadlineWith(new IntakeInpdtakeCommand(this.intake, this.operator.leftStick.y, new IntakeCycleCommand(this.intake)))
        // );

        this.operator.a.toggleWhenPressed(indexercyclecommand);
        ...
        //need to verify if this auto-adjustment works (based on the calculation put directly into the controller command)
       

        
            this.operator.x.toggleWhenPressed(shooterCommand);
        ...
        this.climber.control(Axis.fromButton(this.driver.dPad.down).subtract(Axis.fromButton(this.driver.dPad.up))).setAsDefault();

        this.driver.dPad.up.whenHeld(this.climber.set(-1));
        this.driver.dPad.down.whenHeld(this.climber.set(1));
