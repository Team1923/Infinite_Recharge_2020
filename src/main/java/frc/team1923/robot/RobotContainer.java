...
import frc.team1923.robot.commands.indexer.IndexerShiftCommand;
...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        this.operator.b.whenHeld(new TurretFollowCommand(this));
        this.operator.a.whenHeld(new IndexerShiftCommand(this));

        this.operator.dPad.down.whenPressed(new IntakeCycleCommand(this));
